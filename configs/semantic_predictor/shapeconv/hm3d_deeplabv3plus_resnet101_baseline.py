...
# 2. configuration for train/tes
root_workdir = '/srv/flash1/rramrakhya6/spring_2022/AnalyzeSemanticDataset/dependencies/ShapeConv/summary/'
dataset_type = 'NYUV2Dataset'
dataset_root = '/srv/flash1/rramrakhya6/spring_2022/AnalyzeSemanticDataset/data/hm3d_semantic/segmentation_shapeconv/'
