...
export PYTHONPATH=/srv/flash1/rramrakhya6/spring_2022/habitat-sim/

config="habitat_baselines/config/objectnav/il_rl/ddppo_rgb_ovrl_ft_objectnav.yaml"

TENSORBOARD_DIR="tb/objectnav_il_rl_ft/ddppo_hm3d_pt_s_path_240k/rgb_ovrl_with_augs/sparse_reward_ckpt_66_no_schedule/hm3d_v0_1_0/seed_1/"
CHECKPOINT_DIR="data/new_checkpoints/objectnav_il_rl_ft/ddppo_hm3d_pt_s_path_240k/rgb_ovrl_with_augs/sparse_reward_ckpt_66_no_schedule/hm3d_v0_1_0/seed_1/"
