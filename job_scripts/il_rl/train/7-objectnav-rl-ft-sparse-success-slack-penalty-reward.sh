...
TENSORBOARD_DIR="tb/objectnav_il_rl_ft/ddppo_hm3d_pt_77k/sem_seg_pred/sparse_success_slack_penalty_ckpt_28/hm3d_v0_1_0/seed_1/"
CHECKPOINT_DIR="data/new_checkpoints/objectnav_il_rl_ft/ddppo_hm3d_pt_77k/sem_seg_pred/sparse_success_slack_penalty_ckpt_28/hm3d_v0_1_0/seed_1/"
...
TASK_CONFIG.TASK.MEASUREMENTS "['DISTANCE_TO_GOAL', 'SUCCESS', 'SPL', 'SOFT_SPL', 'TRAIN_SUCCESS', 'STRICT_SUCCESS', 'SIMPLE_REWARD']" \
...
TASK_CONFIG.TASK.SIMPLE_REWARD.USE_SLACK_PENALTY True \
