...
TENSORBOARD_DIR="tb/objectnav_il_rl_ft/ddppo_hm3d_pt_s_path_240k/rgb_ovrl_with_augs/sparse_reward_ckpt_66_no_lr_decay/hm3d_v0_1_0/seed_1/"
CHECKPOINT_DIR="data/new_checkpoints/objectnav_il_rl_ft/ddppo_hm3d_pt_s_path_240k/rgb_ovrl_with_augs/sparse_reward_ckpt_66_no_lr_decay/hm3d_v0_1_0/seed_1/"
...
RL.Finetune.start_actor_finetuning_at 500 \
RL.Finetune.actor_lr_warmup_update 500 \
RL.Finetune.start_critic_warmup_at 500 \
RL.Finetune.critic_lr_decay_update 500 \
RL.Finetune.policy_ft_lr 1.5e-5 \
