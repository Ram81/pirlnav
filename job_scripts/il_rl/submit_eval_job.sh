...
# TENSORBOARD_DIR="tb/objectnav_il_rl_ft/ddppo_hm3d_pt_s_path_240k/sem_seg_pred/sparse_reward_ckpt_16/train_split/seed_1/v1_fixed_evals/ckpt_38_train_sample_4k_random/"
# EVAL_CKPT_PATH_DIR="data/new_checkpoints/objectnav_il_rl_ft/ddppo_hm3d_pt_s_path_240k/sem_seg_pred/sparse_reward/train_split/seed_1/ckpt.38.pth"
TENSORBOARD_DIR="tb/objectnav_il_rl_ft/ddppo_hm3d_pt_77k/sem_seg_pred/sparse_reward_pt_ckpt_4/train_split/seed_1/v1_fixed_evals/ckpt_38_train_sample_4k_random/"
EVAL_CKPT_PATH_DIR="data/new_checkpoints/objectnav_il_rl_ft/ddppo_hm3d_pt_77k/sem_seg_pred/sparse_reward_pt_ckpt_4/train_split/seed_1/ckpt.38.pth"
set -x
