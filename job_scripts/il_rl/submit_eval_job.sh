...
TENSORBOARD_DIR="tb/objectnav_il_rl_ft/ddppo/sem_seg_pred/sparse_reward/policy_warmup_critic_decay_mlp/train_split/seed_1/ckpt_35/"
EVAL_CKPT_PATH_DIR="data/new_checkpoints/objectnav_il_rl_ft/ddppo/sem_seg_pred/sparse_reward/policy_warmup_critic_decay_mlp/train_split/seed_2/ckpt.35.pth"
set -x
