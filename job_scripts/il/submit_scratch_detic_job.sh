...
TENSORBOARD_DIR="tb/objectnav_il/objectnav_hm3d/objectnav_hm3d_10k_detic/seed_1/"
CHECKPOINT_DIR="data/new_checkpoints/objectnav_il/objectnav_hm3d/objectnav_hm3d_10k_detic/seed_1/"
...
MODEL.SEMANTIC_PREDICTOR.name "detic" \