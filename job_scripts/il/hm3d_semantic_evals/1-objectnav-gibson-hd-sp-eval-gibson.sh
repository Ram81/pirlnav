...
config=$1
DATA_PATH="data/datasets/objectnav/objectnav_gibson/objectnav_gibson_v4/"
TENSORBOARD_DIR="tb/objectnav_il/objectnav_gibson/objectnav_gibson_hd_40k/sem_seg_pred/seed_1/gibson_v4_evals/"
