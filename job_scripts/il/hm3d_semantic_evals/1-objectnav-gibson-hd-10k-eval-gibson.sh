...
TENSORBOARD_DIR="tb/objectnav_il/objectnav_gibson/objectnav_gibson_10k/seed_1/gibson_evals/ckpt_32_val/"
EVAL_CKPT_PATH_DIR="data/new_checkpoints/objectnav_il/objectnav_gibson/objectnav_gibson_10k/seed_1/ckpt.32.pth"
set -x
